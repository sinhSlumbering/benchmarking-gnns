...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs):
    ...
    _, test_f1, test_total_predicted_as_1, test_total_correctly_predicted_as_1 = evaluate_network(
        model, device, test_loader, epoch)
    _, train_f1, train_total_predicted_as_1, train_total_correctly_predicted_as_1 = evaluate_network(
...
def main():
    ...
    parser.add_argument(
        '--dataset', help="Please give a value for dataset name")
    ...
    parser.add_argument(
        '--layer_type', help="Please give a value for layer_type (for GAT and GatedGCN only)")
